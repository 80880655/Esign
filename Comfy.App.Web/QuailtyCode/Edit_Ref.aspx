<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit_Ref.aspx.cs" Inherits="Comfy.App.Web.QuailtyCode.Edit_Ref" EnableEventValidation="false" %>
    ...
    <script>
        ...
        function SearchQC() {
            ...
            if ($("#tQC").val() != "") {
                ...
                var result = AjaxCallFun("Comfy.App.Web", "Comfy.App.Web.QuailtyCode.Edit_Ref", "InitInfo", $("#tQC").val()); //如果只有状态为Approved的才能查询出来，那么这里的查询语句要加多一个判断。
                ...
                $("#avaTable tbody tr td input:text").each(function (i, e) {
        ...
        function InitQCForm(val) {
            ...
            if (val[0] != "") {
                ...
                var result = AjaxCallFun("Comfy.App.Web", "Comfy.App.Web.QuailtyCode.Edit_Ref", "InitInfo", val[0]);
                var strTemp;
        ...
        $(function () {
            ...
            $("#GekComments").attr("readonly", true);
            $("#Layout").attr("readonly", true);
            ...
            //                //AjaxCallFun("Comfy.App.Web", "Comfy.App.Web.QuailtyCode.Edit_Ref", "GetGekCommentDetail", param);
            ...
            $("#SaveComments").click(function () {
                ...
                if ($.trim($("#txtComments").val()) == "") {
                    ...
                    var userid = AjaxCallFun("Comfy.App.Web", "Comfy.App.Web.QuailtyCode.Edit_Ref", "GetUserID", "1");
...
<body>
                ...
                <tr>
                    <td style="width: 460px" align="left">
                        ...
                        <div id="customerIdDiv" style="vertical-align:bottom">
                          ...
                          <asp:TextBox runat="server" ID="tCustomerQualityId" ClientIDMode="Static" style="width:60px"></asp:TextBox>
                        ...
                        <div id="commentsDiv" style="text-align:center;display:none;background-color:White;border:1px solid #FFA200;">
                            ...
                            <input type="button" id="ExitComments" value="Exit" class="myButton" />
                                 ...
                                 <table style="width:100%">
                                   ...
                                   <tr>
                                     <td>
                                     <asp:TextBox runat="server" ID="txtAvaRemark" ClientIDMode="Static" Style="border: 1px solid #FFA200;" TextMode="MultiLine" Width="96%" Height="60px" ReadOnly></asp:TextBox>
                                     </td>
                                   </tr>
                                 </table>
    ...
    <asp:ObjectDataSource ID="YarnInfoODS" runat="server" SelectMethod="GetYarnInfo"
        InsertMethod="AddYarnInfo" UpdateMethod="EditYarnInfo" DeleteMethod="DeleteYarnInfo" TypeName="Comfy.App.Web.QuailtyCode.Edit_Ref"
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#assignConfirm").click(function () {
            ...
            var result = AjaxCallFun("Comfy.App.Web", "Comfy.App.Web.QuailtyCode.Edit_Ref", "AssignQC", paramsb);
            if (result == "1") {
    ...
    $(function () {
        $("#btnExit").click(function () {
            try {
                ...
                //  Dialog.getInstance("Edit_Ref").close();
            } catch (e) {
                window.opener = null;
                window.open('', '_self');
                window.close();
        ...
        $("#btnDisable").click(function () {
            ...
            var tempQC = $("#tQC").val();
            if (tempQC != "") {
                var result = AjaxCallFun("Comfy.App.Web", "Comfy.App.Web.QuailtyCode.Edit_Ref", "DisableQC", tempQC);
                if (result == "1") {
                    alert("Success!");
                } else {
                    alert("Fail  " + result);
    ...
    $("#btnTransferToAX").click(function () {
        ...
        alert(result);
        //        var result = AjaxCallFunOne("Comfy.App.Web", "Comfy.App.Web.QuailtyCode.Edit_Ref", "QCTrasferToAX", sQC);
        //        alert(result);
        return false;
    });
